...
DATA_DIR = "/dettest_data/DTU_dettest/DTU_fullfp_bringup/TDI/IPhisweep/SCI/20260915-104406"
#DATA_DIR = "/dettest_data/DTU_dettest/DTU_fullfp_bringup/PTC/SCI/20260721-174626"

bias_fls = os.path.join(DATA_DIR, "*TDIbias900*.fits")
...
crtr = ImageCreator(detector_config=cfgdat)
crtr.logger.setLevel(logging.DEBUG)
